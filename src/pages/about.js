    ...
    <Layout>
        ...
        <article>
          ...
          <div className={styles.content}>
            <p>Hi, my name is <span>Jonathan Runeke</span>. I’m a 21 year old student from Sweden with a passion for software development and design. </p>
            {
              readMoreMe && (
                <div className="more">
                  <p>For around 12 years I have been teaching myself programming by making games, simulations, apps and much more. Currently, I’m studying computer sience and engineering at <span>Lunds Tekniska Högskola</span> with 3 out of 5 years left.</p>
                  <p>Outside of developing software I love to play guitar, play any sport or hang out with friends and play boardgames or watch movies. </p>   
                </div>
              )
            }
      ...
      <div className={styles.devyne}>
        <article>
          ...
          <div className={styles.content}>
            <p>Devyne Software AB is a project that I started to help others create new platforms for their audiences to use. </p>
            {
              readMoreDevyne && (
                <div className="more">
